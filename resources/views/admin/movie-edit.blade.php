    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form enctype="multipart/form-data" method="POST" action="{{ route('admin.movie.update', $movies->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group">
                            <label for="title">Title</label>
                            <input type="text" class="form-control" value="{{ old('title', $movies->title) }}"
                                id="title" name="title" placeholder="e.g Guardian of The Galaxy">
                        </div>
                        <div class="form-group">
                            <label for="trailer">Trailer</label>
                            <input type="text" class="form-control" value="{{ old('trailer', $movies->trailer) }}"
                                id="trailer" name="trailer" placeholder="Video url">
                        </div>

                        <div class="form-group">
                            <label for="movie">Movie</label>
                            <input type="text" class="form-control" value="{{ old('movie', $movies->movie) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="duration"
                                value="{{ old('duration', $movies->duration) }}" name="duration" placeholder="1h 39m">
                        </div>

                        <div class="form-group">
                            <label>Date:</label>
                            <div class="input-group date" id="release-date" data-target-input="nearest">
                                <input type="text" value="{{ old('release_date', $movies->release_date) }}"
                                    name="release_date" class="form-control datetimepicker-input"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ old('casts', $movies->casts) }}"
                                id="short-about" name="casts" placeholder="Jackie Chan">
                        </div>

                        <div class="form-group">
                            <label for="short-about">Categories</label>
                            <input type="text" class="form-control" id="short-about"
                                value="{{ old('categories', $movies->categories) }}" name="categories"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="short-about"
                                value="{{ old('short_about', $movies->short_about) }}" name="short_about"
                                placeholder="Awesome Movie">
                        </div>
                        <div class="form-group">
                            <label for="short-about">About</label>
                            <input type="text" class="form-control" value="{{ old('about', $movies->about) }}"
